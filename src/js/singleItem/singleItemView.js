export function render(item, isFaved) {

    const appContainer = document.querySelector('#app');
    const markup = 
    `<div class="container p-0 pt-5">
    <div class="heading-1">
        ${item.title}, ${item.square} м2 ${item.price_total} ₽
    </div>
    ...
    <div class="modal">
        <div class="modal__header">
            ...
            <div class="modal__details">
                Квартира <span>${item.flat_number}</span> в Первом квартале Дом ${item.building}
                <div class="modal__details-art">${item.scu}</div>
            </div>
        </div>
...
export function toggleButton(isFaved) {
